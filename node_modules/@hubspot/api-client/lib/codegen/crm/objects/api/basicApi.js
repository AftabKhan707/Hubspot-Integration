...
class BasicApi {
     ...
     */
    getById(objectType, objectId, properties, associations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/{objectType}/{objectId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(objectType, limit, after, properties, associations, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/{objectType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
            let localVarQueryParameters = {};
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    update(objectType, objectId, simplePublicObjectInput, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/{objectType}/{objectId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
