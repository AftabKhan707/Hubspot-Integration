...
class SearchApi {
     ...
     */
    doSearch(objectType, publicObjectSearchRequest, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseWithTotalSimplePublicObjectForwardPaging");
