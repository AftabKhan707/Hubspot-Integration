...
export declare class BatchApi {
     ...
     */
    archive(objectType: string, batchInputSimplePublicObjectId: BatchInputSimplePublicObjectId, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    create(objectType: string, batchInputSimplePublicObjectInput: BatchInputSimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    read(objectType: string, batchReadInputSimplePublicObjectId: BatchReadInputSimplePublicObjectId, archived?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    update(objectType: string, batchInputSimplePublicObjectBatchInput: BatchInputSimplePublicObjectBatchInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
