...
export declare class BasicApi {
     ...
     */
    getById(objectType: string, objectId: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(objectType: string, limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, archived?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    update(objectType: string, objectId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
