...
class AssociationsApi {
     ...
     * @param associationType
     */
    create(objectType, objectId, toObjectType, toObjectId, associationType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/{objectType}/{objectId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)))
     ...
     */
    getAll(objectType, objectId, toObjectType, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseAssociatedIdForwardPaging");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
