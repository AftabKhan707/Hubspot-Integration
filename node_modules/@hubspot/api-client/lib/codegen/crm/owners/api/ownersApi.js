...
exports.OwnersApi = exports.OwnersApiApiKeys = void 0;
...
// ===============================================
var OwnersApiApiKeys;
(function (OwnersApiApiKeys) {
    OwnersApiApiKeys[OwnersApiApiKeys["hapikey"] = 0] = "hapikey";
})(OwnersApiApiKeys = exports.OwnersApiApiKeys || (exports.OwnersApiApiKeys = {}));
class OwnersApi {
    ...
    setApiKey(key, value) {
        this.authentications[OwnersApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    getById(ownerId, idProperty, archived, options = { headers: {} }) {
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(email, after, limit, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponsePublicOwnerForwardPaging");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
