...
export declare enum UserAccountsApiApiKeys {
    hapikey = 0
}
export declare class UserAccountsApi {
    ...
    setApiKey(key: UserAccountsApiApiKeys, value: string): void;
     ...
     */
    archive(accountId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    replace(createUserAccountRequestExternal: CreateUserAccountRequestExternal, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
