...
export declare enum SyncApiApiKeys {
    hapikey = 0
}
export declare class SyncApi {
    ...
    setApiKey(key: SyncApiApiKeys, value: string): void;
     ...
     */
    createContact(appId: number, syncContactsRequest: SyncContactsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createProduct(appId: number, syncProductsRequest: SyncProductsRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
