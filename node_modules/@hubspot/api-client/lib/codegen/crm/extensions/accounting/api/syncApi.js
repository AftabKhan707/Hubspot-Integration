...
exports.SyncApi = exports.SyncApiApiKeys = void 0;
...
// ===============================================
var SyncApiApiKeys;
(function (SyncApiApiKeys) {
    SyncApiApiKeys[SyncApiApiKeys["hapikey"] = 0] = "hapikey";
})(SyncApiApiKeys = exports.SyncApiApiKeys || (exports.SyncApiApiKeys = {}));
class SyncApi {
    ...
    setApiKey(key, value) {
        this.authentications[SyncApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    createContact(appId, syncContactsRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(syncContactsRequest, "SyncContactsRequest")
            };
     ...
     */
    createProduct(appId, syncProductsRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(syncProductsRequest, "SyncProductsRequest")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
