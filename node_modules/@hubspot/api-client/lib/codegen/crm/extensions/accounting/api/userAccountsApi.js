...
(function (UserAccountsApiApiKeys) {
    UserAccountsApiApiKeys[UserAccountsApiApiKeys["hapikey"] = 0] = "hapikey";
...
class UserAccountsApi {
     ...
     */
    archive(accountId, options = { headers: {} }) {
     ...
     */
    replace(createUserAccountRequestExternal, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(createUserAccountRequestExternal, "CreateUserAccountRequestExternal")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
