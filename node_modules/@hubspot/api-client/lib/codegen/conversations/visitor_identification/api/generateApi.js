...
exports.GenerateApi = exports.GenerateApiApiKeys = void 0;
...
// ===============================================
var GenerateApiApiKeys;
(function (GenerateApiApiKeys) {
    GenerateApiApiKeys[GenerateApiApiKeys["hapikey"] = 0] = "hapikey";
})(GenerateApiApiKeys = exports.GenerateApiApiKeys || (exports.GenerateApiApiKeys = {}));
class GenerateApi {
    ...
    setApiKey(key, value) {
        this.authentications[GenerateApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    generateToken(identificationTokenGenerationRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(identificationTokenGenerationRequest, "IdentificationTokenGenerationRequest")
            };
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "IdentificationTokenResponse");
