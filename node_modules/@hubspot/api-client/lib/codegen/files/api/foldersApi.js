...
(function (FoldersApiApiKeys) {
    FoldersApiApiKeys[FoldersApiApiKeys["hapikey"] = 0] = "hapikey";
...
class FoldersApi {
     ...
     */
    archive(folderId, options = { headers: {} }) {
     ...
     */
    archiveByPath(folderPath, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    checkUpdateStatus(taskId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "FolderActionResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    create(folderInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(folderInput, "FolderInput")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
     ...
     */
    doSearch(properties, after, before, limit, sort, id, createdAt, createdAtLte, createdAtGte, updatedAt, updatedAtLte, updatedAtGte, name, path, parentFolderId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseFolder");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getById(folderId, properties, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/files/v3/folders/{folderId}'
                .replace('{' + 'folderId' + '}', encodeURIComponent(String(folderId)));
            let localVarQueryParameters = {};
     ...
     * @param properties Properties to set on returned folder.
     */
    getByPath(folderPath, properties, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/files/v3/folders/{folderPath}'
                .replace('{' + 'folderPath' + '}', encodeURIComponent(String(folderPath)));
            let localVarQueryParameters = {};
     ...
     */
    updateProperties(folderUpdateInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(folderUpdateInput, "FolderUpdateInput")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "FolderUpdateTaskLocator");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
