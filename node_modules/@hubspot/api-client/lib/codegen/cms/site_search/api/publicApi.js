...
(function (PublicApiApiKeys) {
    PublicApiApiKeys[PublicApiApiKeys["hapikey"] = 0] = "hapikey";
})(PublicApiApiKeys = exports.PublicApiApiKeys || (exports.PublicApiApiKeys = {}));
class PublicApi {
    ...
    getById(contentId, type, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (type !== undefined) {
                localVarQueryParameters['type'] = models_1.ObjectSerializer.serialize(type, "'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE'");
            }
     ...
     */
    search(q, limit, offset, language, matchPrefix, autocomplete, popularityBoost, boostLimit, minScore, boostRecent, tableId, hubdbQuery, domain, type, pathPrefix, property, length, groupId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (type !== undefined) {
                localVarQueryParameters['type'] = models_1.ObjectSerializer.serialize(type, "Array<'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE'>");
            }
