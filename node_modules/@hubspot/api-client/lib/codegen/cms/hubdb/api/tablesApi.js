...
class TablesApi {
     ...
     */
    createTable(hubDbTableV3Request, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(hubDbTableV3Request, "HubDbTableV3Request")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
     ...
     */
    getAllDraftTables(sort, after, limit, createdAt, createdAfter, createdBefore, updatedAt, updatedAfter, updatedBefore, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param archived Specifies whether to return archived tables. Defaults to &#x60;false&#x60;.
     */
    getAllTables(sort, after, limit, createdAt, createdAfter, createdBefore, updatedAt, updatedAfter, updatedBefore, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     */
    importDraftTable(tableIdOrName, config, file, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param includeForeignIds Set this to &#x60;true&#x60; to populate foreign ID values in the response.
     */
    unpublishTable(tableIdOrName, includeForeignIds, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param includeForeignIds Set this to &#x60;true&#x60; to populate foreign ID values in the result.
     */
    updateDraftTable(tableIdOrName, hubDbTableV3Request, archived, includeForeignIds, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables/{tableIdOrName}/draft'
                .replace('{' + 'tableIdOrName' + '}', encodeURIComponent(String(tableIdOrName)));
            let localVarQueryParameters = {};
