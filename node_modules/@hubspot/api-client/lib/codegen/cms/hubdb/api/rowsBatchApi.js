...
class RowsBatchApi {
     ...
     */
    batchCreateDraftTableRows(tableIdOrName, batchInputHubDbTableRowV3Request, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(batchInputHubDbTableRowV3Request, "BatchInputHubDbTableRowV3Request")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
     ...
     * @param batchInputHubDbTableRowV3Request JSON array of row objects.
     */
    batchReplaceDraftTableRows(tableIdOrName, batchInputHubDbTableRowV3Request, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
