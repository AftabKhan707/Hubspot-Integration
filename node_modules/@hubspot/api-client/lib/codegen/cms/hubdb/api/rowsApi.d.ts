...
export declare class RowsApi {
     ...
     */
    cloneDraftTableRow(tableIdOrName: string, rowId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createTableRow(tableIdOrName: string, hubDbTableRowV3Request: HubDbTableRowV3Request, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param rowId The ID of the row
     */
    getDraftTableRowById(tableIdOrName: string, rowId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param rowId The ID of the row
     */
    getTableRow(tableIdOrName: string, rowId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getTableRows(tableIdOrName: string, sort?: Array<string>, after?: string, limit?: number, properties?: Array<string>, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param rowId The ID of the row
     */
    purgeDraftTableRow(tableIdOrName: string, rowId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    readDraftTableRows(tableIdOrName: string, sort?: Array<string>, after?: string, limit?: number, properties?: Array<string>, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    replaceDraftTableRow(tableIdOrName: string, rowId: string, hubDbTableRowV3Request: HubDbTableRowV3Request, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    updateDraftTableRow(tableIdOrName: string, rowId: string, hubDbTableRowV3Request: HubDbTableRowV3Request, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
