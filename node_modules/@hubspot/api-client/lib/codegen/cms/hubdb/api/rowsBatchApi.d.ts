...
export declare class RowsBatchApi {
     ...
     */
    batchCreateDraftTableRows(tableIdOrName: string, batchInputHubDbTableRowV3Request: BatchInputHubDbTableRowV3Request, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param batchInputHubDbTableRowV3Request JSON array of row objects.
     */
    batchReplaceDraftTableRows(tableIdOrName: string, batchInputHubDbTableRowV3Request: BatchInputHubDbTableRowV3Request, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
