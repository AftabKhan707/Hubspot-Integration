...
exports.DefinitionsApi = exports.DefinitionsApiApiKeys = void 0;
...
// ===============================================
var DefinitionsApiApiKeys;
(function (DefinitionsApiApiKeys) {
    DefinitionsApiApiKeys[DefinitionsApiApiKeys["developer_hapikey"] = 0] = "developer_hapikey";
    DefinitionsApiApiKeys[DefinitionsApiApiKeys["hapikey"] = 1] = "hapikey";
})(DefinitionsApiApiKeys = exports.DefinitionsApiApiKeys || (exports.DefinitionsApiApiKeys = {}));
class DefinitionsApi {
    ...
    setApiKey(key, value) {
        this.authentications[DefinitionsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param appId
     */
    archive(definitionId, appId, options = { headers: {} }) {
     ...
     */
    create(appId, extensionActionDefinitionInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(extensionActionDefinitionInput, "ExtensionActionDefinitionInput")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.developer_hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.developer_hapikey.applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "ExtensionActionDefinition");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getById(definitionId, appId, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/automation/v4/actions/{appId}/{definitionId}'
                .replace('{' + 'definitionId' + '}', encodeURIComponent(String(definitionId)))
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
     ...
     * @param archived Whether to include archived custom actions.
     */
    getPage(appId, limit, after, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/automation/v4/actions/{appId}'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseExtensionActionDefinitionForwardPaging");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    update(definitionId, appId, extensionActionDefinitionPatch, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/automation/v4/actions/{appId}/{definitionId}'
                .replace('{' + 'definitionId' + '}', encodeURIComponent(String(definitionId)))
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(extensionActionDefinitionPatch, "ExtensionActionDefinitionPatch")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.developer_hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.developer_hapikey.applyToRequest(localVarRequestOptions));
