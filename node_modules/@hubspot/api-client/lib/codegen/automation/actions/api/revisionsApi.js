...
exports.RevisionsApi = exports.RevisionsApiApiKeys = void 0;
...
// ===============================================
var RevisionsApiApiKeys;
(function (RevisionsApiApiKeys) {
    RevisionsApiApiKeys[RevisionsApiApiKeys["developer_hapikey"] = 0] = "developer_hapikey";
    RevisionsApiApiKeys[RevisionsApiApiKeys["hapikey"] = 1] = "hapikey";
})(RevisionsApiApiKeys = exports.RevisionsApiApiKeys || (exports.RevisionsApiApiKeys = {}));
class RevisionsApi {
    ...
    setApiKey(key, value) {
        this.authentications[RevisionsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param appId
     */
    getById(definitionId, revisionId, appId, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "ActionRevision");
     ...
     */
    getPage(definitionId, appId, limit, after, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseActionRevisionForwardPaging");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
...
exports.RevisionsApi = RevisionsApi;
