...
(function (CallbacksApiApiKeys) {
    CallbacksApiApiKeys[CallbacksApiApiKeys["developer_hapikey"] = 0] = "developer_hapikey";
    CallbacksApiApiKeys[CallbacksApiApiKeys["hapikey"] = 1] = "hapikey";
...
class CallbacksApi {
     ...
     */
    complete(callbackId, callbackCompletionRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(callbackCompletionRequest, "CallbackCompletionRequest")
            };
     ...
     */
    completeBatch(batchInputCallbackCompletionBatchRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(batchInputCallbackCompletionBatchRequest, "BatchInputCallbackCompletionBatchRequest")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
