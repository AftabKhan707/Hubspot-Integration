...
class Client {
    constructor(options = {}) {
        ...
        this._oauthAccessTokensApi = new api_34.AccessTokensApi();
        this._oauthRefreshTokensApi = new api_34.RefreshTokensApi();
        this._oauthTokensApi = new api_34.TokensApi();
        ...
        this._contactsGDPRApi = new api_15.GDPRApi();
        ...
        this._objectsGDPRApi = new api_22.GDPRApi();
        this._objectsSearchApi = new api_22.SearchApi();
        this._ownersApi = new api_24.OwnersApi();
        ...
        this._publicObjectSchemasApi = new api_29.PublicObjectSchemasApi();
        ...
        this._publicSmtpTokensApi = new api_33.PublicSmtpTokensApi();
        this._singleSendApi = new api_33.SingleSendApi();
        this._settingsApi = new api_35.SettingsApi();
        this._subscriptionsApi = new api_35.SubscriptionsApi();
        this._auditLogsApi = new api_2.AuditLogsApi();
        this._authorApi = new api_3.AuthorApi();
        this._blogPostApi = new api_4.BlogPostApi();
        this._tagApi = new api_5.TagApi();
        ...
        this._publicPerformanceApi = new api_8.PublicPerformanceApi();
        this._redirectsApi = new api_10.RedirectsApi();
        this._generateApi = new api_12.GenerateApi();
        this._publicApi = new api_9.PublicApi();
